...
def SmpPts_Interior_Square2D(num_intrr_pts, sub_dom, dim_prob=2):  
    """ sub_dom = 1 refers to the left subproblem
        sub_dom = 2 refers to the right subproblem
...
# draw sample points uniformly at random from the boundaries (not including the interface)
