...
from Solver_Robin_RRLA import SolverRobinRRLA
...
while((ite_index < args.max_ite_num)):
    ...
    model_right, error_L2_right, error_H1_right = SolverRobinRRLA(args, traindata_intfc, model_left, ite_index, sub_dom=2)
