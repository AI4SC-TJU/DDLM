...
parser.add_argument('-r', '--result', default='Results/1_2Prob-2D/RR-PINNs/G1e_2-N2e4-baselinecos/simulation-0', type=str, metavar='PATH', help='path to save checkpoint')
...
while((ite_index < args.max_ite_num)):
    ...
    model_right, error_L2_right, error_H1_right = RobinSolverPINN(args, traindata_bndry_G, dataloader_bndry_G, SmpPts_Intfc, g_right, ite_index, 2)
