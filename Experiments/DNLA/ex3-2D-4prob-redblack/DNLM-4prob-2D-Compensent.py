...
## parser arguments
parser = argparse.ArgumentParser(description='DNLM(PINN) method for Poisson problem with 4 sub-domains(ex2)')

# path for saving results
parser.add_argument('-r', '--result', default='Results/2_4Prob-2D/DNLM(PINN)/G1e_2-N2e4-baseline/simulation-test', type=str, metavar='PATH', help='path to save checkpoint')
