...
def DirichletSolverPINN(args, traindata_bndry_G, dataloader_bndry_G_1, dataloader_bndry_G_2, dataloader_bndry_G_3, dataloader_bndry_G_4, iter_num, u_cross, sub_dom='R'):
