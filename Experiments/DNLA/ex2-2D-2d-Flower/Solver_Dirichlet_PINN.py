...
def SolverDirichletPINN(args, traindata_intfc, iter_num, sub_dom=1):
    ...
    plt.figure()
    plt.scatter(traindata_intrr.SmpPts_intrr[:,0], traindata_intrr.SmpPts_intrr[:,1], c = 'red' , label = 'interior points of Dirichlet subproblem' )
    plt.scatter(traindata_bndry.SmpPts_bndry[:,0],  traindata_bndry.SmpPts_bndry[:,1], c = 'black', label = 'boundary of Dirichlet subproblem' )
