...
def SmpPts_Interior_Square10D(num_intrr_pts, sub_dom, dim_prob=10):    
    if sub_dom == 1:
...
def SmpPts_Boundary_Square10D(num_bndry_pts, sub_dom, dim_prob=10):
    if sub_dom==1:
...
def SmpPts_Interface_Square10D(num_bndry_pts, dim_prob=10):    
...
def SmpPts_Test_Square10D(num_test_pts,sub_dom, dim_prob=10):
