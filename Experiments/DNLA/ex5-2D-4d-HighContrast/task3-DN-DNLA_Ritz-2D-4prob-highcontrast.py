...
from Solver_Dirichlet_Ritz import SolverDirichletRitz
...
while((ite_index < args.max_ite_num)):
    ...
    model_1, error_L2_1, error_H1_1 = SolverDirichletRitz(args, traindata_bndry_G_2, dataloader_bndry_G_1, dataloader_bndry_G_2, ite_index, u_cross , sub_dom=1)    

    u_cross = model_1(cross_point)
    u_cross = u_cross.detach()


    model_3, error_L2_3, error_H1_3 = SolverDirichletRitz(args, traindata_bndry_G_2, dataloader_bndry_G_3, dataloader_bndry_G_4, ite_index, u_cross, sub_dom=3)    
