...
while((ite_index < args.max_ite_num)):
    ...
    grad_u_1 = grad_u_1[:,0].detach() * args.c_1 / args.c_2
    grad_u_2 = grad_u_2[:,1].detach() * args.c_1 / args.c_2   
    grad_u_3 = grad_u_3[:,0].detach() * args.c_1 / args.c_2
    grad_u_4 = grad_u_4[:,1].detach() * args.c_1 / args.c_2
    traindata_bndry_G_1.h_smppts = grad_u_1.reshape(-1,1)
    traindata_bndry_G_2.h_smppts = grad_u_2.reshape(-1,1)
    traindata_bndry_G_3.h_smppts = grad_u_3.reshape(-1,1)
    traindata_bndry_G_4.h_smppts = grad_u_4.reshape(-1,1)


    # black block subproblem-solving

    
    model_2, error_L2_2, error_H1_2 = SolverNeumannPINN(args, traindata_bndry_G_1, dataloader_bndry_G_3, dataloader_bndry_G_2, ite_index, u_cross, sub_dom=2)

    model_4, error_L2_4, error_H1_4 = SolverNeumannPINN(args, traindata_bndry_G_1, dataloader_bndry_G_1, dataloader_bndry_G_4, ite_index, u_cross, sub_dom=4)
