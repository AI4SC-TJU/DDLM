...
from Solver_Dirichlet_DeepRitz import SolverDirichletDeepRitz
...
## ----------------------------- ##
## parser arguments
parser = argparse.ArgumentParser(description='DNLM(Ritz) method for Poisson problem(ex1)')
...
logger = helper.Logger(os.path.join(args.result, 'log.txt'), title='DNLM-DeepRitz-2D-2prob-line')
