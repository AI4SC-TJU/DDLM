...
parser.add_argument('-r', '--result', default='Results/2_2Prob-2D-flower/Compensent/PINN/R=1-B=1000/simulation-test', type=str, metavar='PATH', help='path to save checkpoint')
