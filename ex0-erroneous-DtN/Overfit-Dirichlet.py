...
parser.add_argument('-r', '--result', default='Results/Overfit/Dirichlet/2D-squaure/simulation-test', type=str, metavar='PATH', help='path to save checkpoint')
...
parser.add_argument('--alpha', type=float, default=1, help='alpha of the left subproblem')
...
model, error_L2, error_H1 = DirichletSolverPINN(args, traindata_bndry_G, dataloader_bndry_G, SmpPts_Intfc, g, ite_index, 1)
...
torch.save(model.state_dict(), args.result + "/mode_Dirichlet_PINN_ite-%d.pth"%ite_index)
